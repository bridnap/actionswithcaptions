...
function getData(name) {
  ...
  $.ajax({
    url: 'http://gateway.marvel.com:80/v1/public/characters?name=' + name + '&apikey=' + puKey,
    type: "GET",
    dataType: "json",
    success: function(json) {
      ...
      html += '<footer><a href="http://www.marvel.com" target="_blank">' + json.attributionText + '</a></footer>';
